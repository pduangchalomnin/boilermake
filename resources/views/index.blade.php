...
@section('content')
	...
	<section id="intro">
		<div class="master-slider ms-promo-1" id="masterslider-promo">
			...
			<!-- Slide 2 -->
			<div class="ms-slide">
				<img src="/assets/plugins/master-slider/masterslider/style/blank.gif" data-src="/assets/images/promo/promo2.jpg" alt="ALT"/>
				<div class="ms-layer hide-sm text-center" data-type="text" data-delay="10" data-effect="skewleft(50,340)" data-ease="easeOutExpo" data-duration="2200"
					 data-origin= "mc"
					 data-offset-x= "-100"
					 data-offset-y= "15"
	...
	<!-- End Promo Section -->
	<!-- Our food **Major bug in here!**-->
	<section id="ourFood">
		<div class="container-fluid no-side-padding content-lg">
			<div class="container">
				<div class="heading-v20 text-left g-mb-30">
					<span class="heading-v20__pre-title g-dp-block g-mb-20">Our food</span>
					<h2 class="heading-v20__title">Recommended for you!</h2>
				</div>
			</div>
			...
			<div class="tab-v9">
				...
				<div class="tab-content">
					<div class="tab-pane fade in active cleafix" id="meat-t9">
						<div class="row no-column-space">
							...
							<div class="col-md-5">
								<div id="myCarousel2" class="carousel slide carousel-v6">
									<div class="carousel-inner">
										...
										<div class="item">
											<div class="shadow"></div>
											<img src="/assets/images/food/food_big2.jpg" alt="">
											<div class="carousel-caption">
												<span class="carousel-v6__price g-dp-block">$10.30</span>
												<h4 class="carousel-v6__title">Steak with vegetables</h4>
					...
					<div class="tab-pane fade" id="fish-t9">
						<div class="row no-column-space">
							<div class="col-md-7">
								<div class="row no-column-space">
									<div class="col-md-4">
							...
							<div class="col-md-5">
								<div id="myCarousel3" class="carousel slide carousel-v6">
									<div class="carousel-inner">
										<div class="item active">
											<div class="shadow"></div>
										...
										<div class="item">
											...
											<img src="/assets/images/food/food_big2.jpg" alt="">
											<div class="carousel-caption">
												<span class="carousel-v6__price g-dp-block">$110.30</span>
												<h4 class="carousel-v6__title">Steak with vegetables</h4>
												<p class="carousel-v6__text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
											</div>
										</div>
					...
					<div class="tab-pane fade" id="fastfood-t9">
						<div class="row no-column-space">
							<div class="col-md-7">
								<div class="row no-column-space">
									<div class="col-md-4">
							...
							<div class="col-md-5">
								<div id="myCarousel4" class="carousel slide carousel-v6">
									<div class="carousel-inner">
										<div class="item active">
											<div class="shadow"></div>
											<img src="/assets/images/food/food_big1.jpg" alt="">
											<div class="carousel-caption">
												<span class="carousel-v6__price g-dp-block">$5.90</span>
										...
										<div class="item">
											...
											<img src="/assets/images/food/food_big2.jpg" alt="">
											<div class="carousel-caption">
												<span class="carousel-v6__price g-dp-block">$14.60</span>
												<h4 class="carousel-v6__title">Steak with vegetables</h4>
												<p class="carousel-v6__text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
											</div>
										</div>
					...
					<div class="tab-pane fade" id="pizza-t9">
						<div class="row no-column-space">
							<div class="col-md-7">
								<div class="row no-column-space">
									<div class="col-md-4">
							...
							<div class="col-md-5">
								<div id="myCarousel5" class="carousel slide carousel-v6">
									<div class="carousel-inner">
										<div class="item active">
											<div class="shadow"></div>
											<img src="/assets/images/food/food_big1.jpg" alt="">
											<div class="carousel-caption">
												<span class="carousel-v6__price g-dp-block">$12.50</span>
												<h4 class="carousel-v6__title">Steak with special sauce</h4>
												<p class="carousel-v6__text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
											</div>
										</div>
										<div class="item">
											...
											<img src="/assets/images/food/food_big2.jpg" alt="">
											<div class="carousel-caption">
												<span class="carousel-v6__price g-dp-block">$7.30</span>
												<h4 class="carousel-v6__title">Steak with vegetables</h4>
												<p class="carousel-v6__text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
											</div>
										</div>
					...
					<div class="tab-pane fade" id="vegan-t9">
						<div class="row no-column-space">
							<div class="col-md-7">
								<div class="row no-column-space">
									<div class="col-md-4">
							...
							<div class="col-md-5">
								<div id="myCarousel6" class="carousel slide carousel-v6">
									<div class="carousel-inner">
										<div class="item active">
											<div class="shadow"></div>
											<img src="/assets/images/food/food_big1.jpg" alt="">
                            ...
                            <div id="myCarousel" class="carousel slide carousel-v5">
                                <div class="carousel-inner">
                                    <div class="item active equal-height-column">
                                        <div class="shadow"></div>
                                        <img class="equal-height-column" src="/assets/images/about/about1.jpg" alt="">
                                    </div>
                                    <div class="item equal-height-column">
                                        <div class="shadow"></div>
                                        <img class="equal-height-column" src="/assets/images/about/about2.jpg" alt="">
                                    </div>
                                    <div class="item equal-height-column">
                                        <div class="shadow"></div>
                                        <img class="equal-height-column" src="/assets/images/about/about3.jpg" alt="">
                                    </div>
                                </div>
                                <div class="carousel-arrow">
	...
	<section id="menu">
		<div class="container content-lg">
			<div class="heading-v20 g-mb-20">
				<span class="heading-v20__pre-title g-dp-block g-mb-20">Our menu</span>
				<h2 class="heading-v20__title g-mb-10">Taste this</h2>
			</div>

			<!-- Tab v8 -->
			<div class="tab-v8">
				<ul class="nav nav-tabs">
					<li class="tab-v8__tab active"><a href="#breakfast" data-toggle="tab">Breakfast</a></li>
					<li class="tab-v8__tab"><a href="#lunch" data-toggle="tab">Lunch</a></li>
					<li class="tab-v8__tab"><a href="#dinner" data-toggle="tab">Dinner</a></li>
				</ul>
					...
					<div class="tab-pane fade in active" id="breakfast">
						<div class="row g-mb-50">
							<div class="col-md-6 g-sm-mb-50">
								<div class="media menu-item">
									<a class="media-left" href="#">
										<img class="media-object menu-item__img rounded-x" src="/assets/images/menu/menu1.jpg" alt="">
									</a>
									<div class="media-body menu-item__body">
										<h4 class="media-heading menu-item__name">Croissants</h4>
										<span class="menu-item__price rounded-5x">$1.20</span>
							...
							<div class="col-md-6">
								<div class="media menu-item">
									<a class="media-left" href="#">
										<img class="media-object menu-item__img rounded-x" src="/assets/images/menu/menu2.jpg" alt="">
									</a>
									<div class="media-body menu-item__body">
										<h4 class="media-heading menu-item__name">Croissants</h4>
										<span class="menu-item__price rounded-5x">$1.20</span>
						...
						<div class="row g-mb-50">
							<div class="col-md-6 g-sm-mb-50">
								<div class="media menu-item">
									<a class="media-left" href="#">
										<img class="media-object menu-item__img rounded-x" src="/assets/images/menu/menu3.jpg" alt="">
									</a>
									<div class="media-body menu-item__body">
										<h4 class="media-heading menu-item__name">Croissants</h4>
										<span class="menu-item__price rounded-5x">$1.20</span>
							...
							<div class="col-md-6">
								<div class="media menu-item">
									<a class="media-left" href="#">
										<img class="media-object menu-item__img rounded-x" src="/assets/images/menu/menu4.jpg" alt="">
									</a>
									<div class="media-body menu-item__body">
										<h4 class="media-heading menu-item__name">Croissants</h4>
										<span class="menu-item__price rounded-5x">$1.20</span>
						...
						<div class="row g-mb-50">
							<div class="col-md-6 g-sm-mb-50">
								<div class="media menu-item">
									<a class="media-left" href="#">
										<img class="media-object menu-item__img rounded-x" src="/assets/images/menu/menu5.jpg" alt="">
									</a>
									<div class="media-body menu-item__body">
										<h4 class="media-heading menu-item__name">Croissants</h4>
										<span class="menu-item__price rounded-5x">$1.20</span>
							...
							<div class="col-md-6">
								<div class="media menu-item">
									<a class="media-left" href="#">
										<img class="media-object menu-item__img rounded-x" src="/assets/images/menu/menu6.jpg" alt="">
									</a>
									<div class="media-body menu-item__body">
										<h4 class="media-heading menu-item__name">Croissants</h4>
										<span class="menu-item__price rounded-5x">$1.20</span>
						...
						<div class="row">
							<div class="col-md-6 g-sm-mb-50">
								<div class="media menu-item">
									<a class="media-left" href="#">
										<img class="media-object menu-item__img rounded-x" src="/assets/images/menu/menu7.jpg" alt="">
									</a>
									<div class="media-body menu-item__body">
										<h4 class="media-heading menu-item__name">Croissants</h4>
										<span class="menu-item__price rounded-5x">$1.20</span>
							...
							<div class="col-md-6">
								<div class="media menu-item">
									<a class="media-left" href="#">
										<img class="media-object menu-item__img rounded-x" src="/assets/images/menu/menu8.jpg" alt="">
									</a>
									<div class="media-body menu-item__body">
										<h4 class="media-heading menu-item__name">Croissants</h4>
										<span class="menu-item__price rounded-5x">$1.20</span>
			...
			<div class="news g-pt-85 g-pb-100 text-center">
				<div class="container">
					...
					<div class="owl2-carousel-v4 owl-theme">
						<div class="item">
							<div class="post">
								<img class="post__img img-responsive" src="/assets/images/good-taste/good_taste1.jpg" alt="">
						...
						<div class="item">
							<div class="post">
								<img class="post__img img-responsive" src="/assets/images/good-taste/good_taste2.jpg" alt="">
								<div class="post__child text-left">
									<span class="post__child--cat">Steak</span>
									<h3 class="post__child--title g-mb-20">Steak + Potatoes</h3>
									<p class="post__child--text g-mb-20">Curabitur eget tortor sed urna faucibus iaculis id et nulla. Aliquam erat volutpat.</p>
						...
						<div class="item">
							<div class="post">
								<img class="post__img img-responsive" src="/assets/images/good-taste/good_taste3.jpg" alt="">
								<div class="post__child text-left">
									<span class="post__child--cat">Steak</span>
									<h3 class="post__child--title g-mb-20">Steak + Potatoes</h3>
									<p class="post__child--text g-mb-20">Curabitur eget tortor sed urna faucibus iaculis id et nulla. Aliquam erat volutpat.</p>
						...
						<div class="item">
							<div class="post">
								<img class="post__img img-responsive" src="/assets/images/good-taste/good_taste4.jpg" alt="">
								<div class="post__child text-left">
									<span class="post__child--cat">Steak</span>
									<h3 class="post__child--title g-mb-20">Steak + Potatoes</h3>
									<p class="post__child--text g-mb-20">Curabitur eget tortor sed urna faucibus iaculis id et nulla. Aliquam erat volutpat.</p>
						...
						<div class="item">
							<div class="post">
								<img class="post__img img-responsive" src="/assets/images/good-taste/good_taste5.jpg" alt="">
								<div class="post__child text-left">
									<span class="post__child--cat">Steak</span>
									<h3 class="post__child--title g-mb-20">Steak + Potatoes</h3>
									<p class="post__child--text g-mb-20">Curabitur eget tortor sed urna faucibus iaculis id et nulla. Aliquam erat volutpat.</p>
						...
						<div class="item">
							<div class="post">
								<img class="post__img img-responsive" src="/assets/images/good-taste/good_taste6.jpg" alt="">
								<div class="post__child text-left">
									<span class="post__child--cat">Steak</span>
									<h3 class="post__child--title g-mb-20">Steak + Potatoes</h3>
									<p class="post__child--text g-mb-20">Curabitur eget tortor sed urna faucibus iaculis id et nulla. Aliquam erat volutpat.</p>
						...
						<div class="item">
							<div class="post">
								<img class="post__img img-responsive" src="/assets/images/good-taste/good_taste7.jpg" alt="">
								<div class="post__child text-left">
									<span class="post__child--cat">Steak</span>
									<h3 class="post__child--title g-mb-20">Steak + Potatoes</h3>
									<p class="post__child--text g-mb-20">Curabitur eget tortor sed urna faucibus iaculis id et nulla. Aliquam erat volutpat.</p>
						...
						<div class="item">
							<div class="post">
								<img class="post__img img-responsive" src="/assets/images/good-taste/good_taste8.jpg" alt="">
								<div class="post__child text-left">
									<span class="post__child--cat">Steak</span>
									<h3 class="post__child--title g-mb-20">Steak + Potatoes</h3>
									<p class="post__child--text g-mb-20">Curabitur eget tortor sed urna faucibus iaculis id et nulla. Aliquam erat volutpat.</p>
						...
						<div class="item">
							<div class="post">
								<img class="post__img img-responsive" src="/assets/images/good-taste/good_taste9.jpg" alt="">
								<div class="post__child text-left">
									<span class="post__child--cat">Steak</span>
									<h3 class="post__child--title g-mb-20">Steak + Potatoes</h3>
									<p class="post__child--text g-mb-20">Curabitur eget tortor sed urna faucibus iaculis id et nulla. Aliquam erat volutpat.</p>
					...
					<!--
                                            ...
                                            <a href="#" class="btn-u global__btn-u global__btn-u--diff">Book Now</a>
                    -->
				</div>
			</div>
		</div>
